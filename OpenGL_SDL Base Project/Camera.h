...
public:
	...
	void SetAsOrtho(Vector3D aCentre, Vector3D aLookAt, Vector3D aUp, float aLeft, float aRight, float aBottom, float aTop, float aNear, float aFar);
